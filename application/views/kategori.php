            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item me-1 ms-0">
                        <a class="me-lg-3 mb-4 mb-lg-0 btn btn-sm btn-secondary" href="<?= base_url() ?>">Semua (<?= $all ?>)</i></a>
                    </li>
                    <li class="nav-item me-1 ms-0">
                        <a class="me-lg-3 mb-4 mb-lg-0 btn btn-sm btn-danger" href="<?= base_url('kategori/' . strtolower($cat->permalink_kt)) ?>"><?= $cat->nama_kategori ?> (<?= count($kategori) ?>) </i></a>
                    </li>
