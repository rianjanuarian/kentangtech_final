...
class Beranda extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['list']     = $this->m_user->list($offset, $limit);
        ...
        $data['judul']     = 'Beranda | Kentang Tech';
    ...
    public function legal($link)
    {
        ...
        $data['judul']     = $get->nama_kb . ' | Kentang Tech';
        $data['terms']     = $get;
        $this->load->view('template/header', $data);
    ...
    public function kategori($slug)
    {
        ...
        $data['judul']     = "Kategori $nm_kat | Kentang Tech";
    ...
    public function tag($slug)
    {
        ...
        $id_tag = $tag->id_tag;
        $nm_tag = $tag->nama_tag;
        $data['judul']     = "Tag $nm_tag |Kentang Tech";
    ...
    {
        $data['judul']     = "Kategori | Kentang Tech";
        $this->load->view('template/header', $data);
    ...
    public function in_parent($in_parent, $post_id, $store_all_id)
    {
        ...
        if (in_array($in_parent, $store_all_id, false)) {
            ...
            foreach ($result as $re) {
                ...
                <a href="#form_komentar" class="reply-comment" data-nama="' . $re['nama'] . '" id=' . $re['id_komentar'] . '><span></i></span></a>
				</div>
